...
function FieldError({
    ...
    const content = useMemo(() => {
        ...
        // biome-ignore lint/style/useExplicitLengthCheck: component library
        if (!errors?.length) {
            return null;
        }
        ...
        // biome-ignore lint/suspicious/noDoubleEquals: component library
        ...
        return (
            <ul className="ml-4 flex list-disc flex-col gap-1">
                {/** biome-ignore lint/suspicious/noArrayIndexKey: component library */}
