    ...
    return (
        <div
            ...
            className={cn(
                ...
                "border-foreground/10 border-2 border-dashed bg-card text-card-foreground gap-6 overflow-hidden rounded-[12px_25px_15px_30px_/_27px_11px_24px_18px] py-6 text-sm shadow-xs has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl group/card flex flex-col",
                className
            )}
            {...props}
        />
